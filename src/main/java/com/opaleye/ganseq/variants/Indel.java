...
public class Indel extends Variant{
	...
	public Indel(String zygosity, int direction, int type, int indelStartIndex, int indelEndIndex, int focusedIndex,  String indelSeq, boolean onTarget) {
		super();
	...
	private void makeAAChange() {
		...
		String refString = RootController.getRefFile().getRefString();
		String originalSeq = "";
		String shiftedSeq = "";
		String ptnCoordi = "";

		Vector<Integer> cDnaStart = RootController.getRefFile().getcDnaStart();
		Vector<Integer> cDnaEnd = RootController.getRefFile().getcDnaEnd();
