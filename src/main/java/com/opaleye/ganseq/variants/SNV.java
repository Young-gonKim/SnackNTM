...
public class SNV extends Variant{
	...
	public SNV(char refChar, char fwdTraceChar, char revTraceChar, int direction, String cIndex, int alignmentIndex, int fwdTraceIndex, int revTraceIndex, boolean coding, int gIndex, boolean onTarget, String zygosity) {
